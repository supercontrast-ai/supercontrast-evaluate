...
Visit the 🤗 Evaluate [organization](https://huggingface.co/supercontrast_evaluate.Metric) for a full list of available metrics. Each metric has a dedicated Space with an interactive demo for how to use the metric, and a documentation card detailing the metrics limitations and usage.
