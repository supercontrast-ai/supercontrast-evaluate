...
from .record_evaluation import supercontrast_evaluate as evaluate_record
...
Examples:
    ...
    >>> super_glue_metric = supercontrast_evaluate.load('super_glue', 'copa')  # any of ["copa", "rte", "wic", "wsc", "wsc.fixed", "boolq", "axg"]
    >>> predictions = [0, 1]
    >>> references = [0, 1]
    ...
    >>> super_glue_metric = supercontrast_evaluate.load('super_glue', 'cb')
    >>> predictions = [0, 1]
    >>> references = [0, 1]
    >>> results = super_glue_metric.compute(predictions=predictions, references=references)
    >>> print(results)
    ...
    >>> super_glue_metric = supercontrast_evaluate.load('super_glue', 'record')
    ...
    >>> super_glue_metric = supercontrast_evaluate.load('super_glue', 'multirc')
    ...
    >>> super_glue_metric = supercontrast_evaluate.load('super_glue', 'axb')
    >>> references = [0, 1]
    >>> predictions = [0, 1]
    >>> results = super_glue_metric.compute(predictions=predictions, references=references)
    >>> print(results)
